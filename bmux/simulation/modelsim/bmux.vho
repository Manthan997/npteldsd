...
SIGNAL add_instance_aY_a0_combout : std_logic;
...
add_instance_aY_a0 : maxv_lcell
-- Equation(s):
-- add_instance_aY_a0_combout = ((input_vector_acombout(0) & ((input_vector_acombout(2)))) # (!input_vector_acombout(0) & (input_vector_acombout(1))))
...
-- pragma translate_on
PORT MAP (
	datab => input_vector_acombout(1),
	datac => input_vector_acombout(2),
	datad => input_vector_acombout(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => add_instance_aY_a0_combout);
...
-- pragma translate_on
PORT MAP (
	datain => add_instance_aY_a0_combout,
	oe => VCC,
